...
// ─── Main View Component ──────────────────────────────────────────────────────
export function TextbookView({ isEmbedded = false }: { isEmbedded?: boolean } = {}) {
  useAuth();
  ...
  return (
    <div className={`flex ${isEmbedded ? "h-full w-full" : "h-[calc(100vh-80px)]"} overflow-hidden relative`}>
      {/* Toast */}
      {notification && (
